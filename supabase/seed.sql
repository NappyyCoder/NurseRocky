...
VALUES
  (
    ...
    'Module 1: Introduction to Healthcare & CNA Role (6 Hours). Learning Objectives: Define CNA scope of practice; Identify healthcare team roles; Understand workplace professionalism. Topics: Healthcare settings, CNA responsibilities, Legal scope of practice, Professional conduct, HIPAA. Assessment: Quiz, Test.',
    1, 8, 360, TRUE
  ),
  (
...
-- ── Module 1 lessons (lesson bodies live in codebase: lib/course/module1-lesson-bodies.ts) ──
-- Replace Module 1 lessons & quizzes (quizzes cascades quiz_questions + quiz_attempts)
...
-- ── Module 1 assessments (Quiz + Test) ─────────────────────────
WITH
ins_tf AS (
